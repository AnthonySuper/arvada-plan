    ...
    >
      ...
      <CardSection title="Promote Downsize-Friendly Housing" style={{ marginBottom: "12rem" }}>
        <p style={{ marginBottom: "1.5rem" }}>
          ...
          grow over the next few decades. As people get older, have their kids move out, and retire,
          the same house they may have purchased in the 1980s might no longer make sense for their
          needs—but right now, they&apos;d have to leave their communities if they want to downsize.
          It doesn&apos;t have to be this way. A few small changes to our zoning code could make it
          easier for seniors to keep living in their community.
        </p>
        ...
        >
          <h4 style={{ fontWeight: "700", marginBottom: "0.5rem" }}>
            1. Streamline Permitting for ADUs
          </h4>
          <p style={{ marginBottom: "0.75rem", fontSize: "0.95rem" }}>
            Accessory Dwelling Units, also called backyard cottages or mother-in-law apartments, are
            endorsed by the AARP as a great way for longtime residents to find flexible housing
            options that work for them in old age. An ADU is essentially a separate, detached house
            on a lot where a larger house already exists—perfect for seniors who want independence,
            but still need help from their children from time to time.
          </p>
        ...
        <div
          style={{ textAlign: "left", paddingLeft: "1rem", borderLeft: "2px solid var(--primary)" }}
        >
          <h4 style={{ fontWeight: "700", marginBottom: "0.5rem" }}>
            2. Make it easier to build elevators
          </h4>
          <p style={{ fontSize: "0.95rem" }}>
            As seniors age, stairs can become a barrier. Elevators solve this problem by eliminating
            it entirely, but American laws place unnecessarily strict requirements on building them.
            As a result, many small apartment and condo complexes are built as walk-ups instead. We
            could remove those regulatory requirements, bringing our standards more in line with
            those of the rest of the world, and make it easier for people to install elevators.
          </p>
        </div>
      </CardSection>
    </main>
